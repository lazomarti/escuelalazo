  ...
  <div class="container"> <a class="navbar-brand navbar-logo " href="index.html"></a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav ml-auto">
        <li class="nav-item"> <a class="nav-link" href="consulta-filtro.php">Reporte</a> </li>
...
unset($_SESSION['msj']);
 ...
 ?>
  ...
  <input class="controls" type="number" name="cedula" id="correo" placeholder="Ingrese su Cedula" required>
  <input class="controls" type="date" name="fecha"required>
  <h4>Sexo</h4>
