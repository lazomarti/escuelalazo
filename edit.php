...
if(isset($_POST['edit'])){
    ...
    $query = "UPDATE alumnos SET nombres = '$nombres', cedula = '$cedula', fecha = '$fecha', sexo = '$sexo', grado = '$grado', seccion = '$seccion', turno = '$turno' WHERE id = $id";
  ...
  <div class="container"> <a class="navbar-brand navbar-logo " href="index.html"></a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav ml-auto">
        <li class="nav-item"> <a class="nav-link" href="registro.php">Volver</a> </li>
      </ul>
    </div>
  </div>
</nav>
...
<form class="form-register" action="edit.php?id=<?php echo $_GET['id'] ?>" method="post">
  ...
  <input class="controls" type="number" name="cedula" id="correo" placeholder="Ingrese su Cedula" required value="<?php echo $cedula; ?>">
  <input class="controls" type="date" name="fecha"required value="<?php echo $fecha; ?>">
  <h4>Sexo</h4>
