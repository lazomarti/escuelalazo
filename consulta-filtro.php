...
<a href="consulta.php" class="botons2">LISTA COMPLETA</a>   
<form class="form-register" action="consulta-filtro.php" method="post">
<?php
$servidor="localhost";
$usuario="root";
$clave="";
...
if(isset($_POST['b-cedula'])){
  $sql = "SELECT * FROM alumnos WHERE cedula = '".$_POST['b-cedula']."'";
$ejecuta_sentencia = mysqli_query($link, $sql);
}
 ?>

<h4>Busqueda por cedula</h4>
  <input class="controls" type="number" name="b-cedula" id="correo" placeholder="Ingrese su Cedula" required>
 ...
 <form class="form-register" action="consulta-filtro.php" method="post">
  <h4>Filtrar</h4>
  <h4>Grado</h4>
                    <select name="f-grado" id="f-grado">
                    ...
                    <h4>Seccion</h4>
                    <select name="f-seccion" id="f-seccion">
...
if(isset($_POST['f-grado']) and isset($_POST['f-seccion'])){
  ...
  $order_grado_seccion = "SELECT * FROM alumnos WHERE grado = '$f_grado' AND seccion = '$f_seccion'";
...
<table class="tabla" >
  <tbody>    
            <tr>
             ...
             <td class="tabla-titulos">Cedula</td>
             <td class="tabla-titulos">Fecha de N.</td> 
...
<?php
  ...
  if(isset($_POST['f-grado'])){
    $order_grado = "SELECT * FROM alumnos WHERE grado = '$f_grado'";
...
if(isset($_POST['f-seccion'])){
  $order_seccion = "SELECT * FROM alumnos WHERE seccion = '$f_seccion'";
